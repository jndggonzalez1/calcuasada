  ...
  return (
    <article className="space-y-6 text-gray-700">
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">Por qué Monterrey es la capital de la carne asada en México</h2>
      ...
      <section className="space-y-4">
        <h2 className="text-base font-semibold text-gray-900">Los mejores cortes para carne asada regiomontana</h2>
        <p className="text-sm leading-relaxed">
        ...
        <div className="space-y-4">
          <div className="bg-white border border-gray-100 rounded-xl p-4 space-y-2">
            <h3 className="text-sm font-semibold text-gray-900">Arrachera — la reina de la parrilla</h3>
            <p className="text-sm leading-relaxed">
          ...
          <div className="bg-white border border-brasa/30 rounded-xl p-4 space-y-2">
            <div className="flex items-center gap-2 mb-1">
              <h3 className="text-sm font-semibold text-gray-900">Ribeye — el favorito de Yeyito</h3>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-4 space-y-2">
            <h3 className="text-sm font-semibold text-gray-900">Costilla de res — para los que saben</h3>
            <p className="text-sm leading-relaxed">
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-4 space-y-2">
            <h3 className="text-sm font-semibold text-gray-900">Agujas norteñas — el secreto del barrio</h3>
            <p className="text-sm leading-relaxed">
        ...
        <div className="bg-gray-50 rounded-xl p-4 space-y-2">
          <h3 className="text-sm font-semibold text-gray-900">Tabla de comparación de cortes</h3>
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">La campechana: la mezcla perfecta</h2>
        <p className="text-sm leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">La técnica del sellado: el secreto que cambia todo</h2>
        <p className="text-sm leading-relaxed">
        ...
        <div className="space-y-3">
          <div className="bg-white border border-gray-100 rounded-xl p-4">
            <p className="text-sm font-semibold text-gray-900 mb-1">Fase 1 — Sellado a fuego muy alto</p>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-4">
            <p className="text-sm font-semibold text-gray-900 mb-1">Fase 2 — Cocción lenta a fuego medio-bajo</p>
            <p className="text-sm leading-relaxed text-gray-600">
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">Carbón mesquite vs carbón normal: no hay comparación</h2>
        <p className="text-sm leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">Cómo encender el carbón sin químicos</h2>
        <p className="text-sm leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">Temperatura ideal: cómo saberla sin termómetro</h2>
        <p className="text-sm leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">Sal de grano: el único condimento que necesitas</h2>
        <p className="text-sm leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">Errores comunes que arruinan la carne asada</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">Utensilios que no pueden faltar</h2>
      ...
      <div className="bg-gray-50 border border-gray-100 rounded-xl p-5 text-center space-y-3">
        <p className="text-sm font-semibold text-gray-900">¿Ya sabes cuánta carne vas a comprar?</p>
        <p className="text-xs text-gray-500">Usa la calculadora para saber exactamente cuántos kilos necesitas según el número de personas.</p>
        <Link
          href="/"
      ...
      <section className="space-y-3">
        ...
        <div className="grid gap-3">
          ...
          <Link href="/termometro" className="block bg-white border border-gray-100 rounded-xl p-4 hover:border-gray-200 transition-all">
