  ...
  return (
    <div className="space-y-6 text-gray-700">
      <div className="text-center space-y-2">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Acerca de Calcuasada</h1>
        <p className="text-gray-400 text-sm">Hecha en Nuevo León con amor, carbón y mucha arrachera</p>
      </div>

      <section className="bg-gray-50 border border-gray-100 rounded-xl p-5 space-y-3">
        <h2 className="text-base font-semibold text-gray-900">¿Qué es Calcuasada?</h2>
      ...
      <section className="bg-white border border-gray-100 rounded-xl p-5 space-y-3">
        <h2 className="text-base font-semibold text-gray-900">Una nota personal 🤙</h2>
        <p className="text-sm leading-relaxed">
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">¿Qué puedes hacer con Calcuasada?</h2>
      ...
      <section className="space-y-2">
        <h2 className="text-base font-semibold text-gray-900">¿Por qué es gratis?</h2>
        <p className="text-sm leading-relaxed">
      ...
      <div className="bg-gray-50 border border-gray-100 rounded-xl p-5 text-center space-y-3">
        <p className="text-sm font-semibold text-gray-900">¿Ya tienes todo planeado?</p>
        <p className="text-xs text-gray-500">Usa la calculadora y en menos de 15 segundos tienes la lista completa.</p>
        <Link
          href="/"
