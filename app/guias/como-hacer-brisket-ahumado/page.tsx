  ...
  return (
    <article className="space-y-6 text-gray-700">
      ...
      <div className="bg-gray-50 border border-gray-100 rounded-xl p-5 space-y-2">
        <p className="text-sm font-semibold text-gray-900">La regla más importante:</p>
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">Qué es un brisket</h2>
      ...
      <section className="space-y-4">
        <h2 className="text-base font-semibold text-gray-900">Qué equipo puedes usar</h2>
        <p className="text-sm leading-relaxed">
        ...
        <div className="space-y-3">
          <div className="bg-white border border-gray-100 rounded-xl p-4 space-y-1.5">
            <h3 className="text-sm font-semibold text-gray-900">🔥 Offset smoker — el clásico de Texas</h3>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-4 space-y-1.5">
            <h3 className="text-sm font-semibold text-gray-900">🪵 Ahumador de pellets — el más práctico</h3>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-4 space-y-1.5">
            <h3 className="text-sm font-semibold text-gray-900">🟢 Kamado tipo Big Green Egg</h3>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-4 space-y-1.5">
            <h3 className="text-sm font-semibold text-gray-900">🍖 Asador con tapa — la opción accesible</h3>
      ...
      <section className="space-y-4">
        <h2 className="text-base font-semibold text-gray-900">Temperaturas clave</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">Preparación antes de ahumar</h2>
        <p className="text-sm leading-relaxed">
      ...
      <section className="space-y-4">
        <h2 className="text-base font-semibold text-gray-900">Cómo ahumar el brisket paso a paso</h2>

        <ol className="space-y-4">
          <li className="bg-white border border-gray-100 rounded-xl p-4 space-y-1.5">
            <p className="text-sm font-semibold text-gray-900">1. Precalienta el ahumador</p>
          ...
          <li className="bg-white border border-gray-100 rounded-xl p-4 space-y-1.5">
            <p className="text-sm font-semibold text-gray-900">2. Coloca el brisket en indirecto</p>
          ...
          <li className="bg-white border border-gray-100 rounded-xl p-4 space-y-1.5">
            <p className="text-sm font-semibold text-gray-900">3. Deja formar la bark</p>
          ...
          <li className="bg-white border border-gray-100 rounded-xl p-4 space-y-1.5">
            <p className="text-sm font-semibold text-gray-900">4. Envuelve cuando la bark esté lista</p>
          ...
          <li className="bg-white border border-gray-100 rounded-xl p-4 space-y-1.5">
            <p className="text-sm font-semibold text-gray-900">5. Termina por ternura</p>
          ...
          <li className="bg-white border border-gray-100 rounded-xl p-4 space-y-1.5">
            <p className="text-sm font-semibold text-gray-900">6. Reposa antes de cortar</p>
          ...
          <li className="bg-white border border-gray-100 rounded-xl p-4 space-y-1.5">
            <p className="text-sm font-semibold text-gray-900">7. Corta contra la fibra</p>
      ...
      <section className="space-y-4">
        <h2 className="text-base font-semibold text-gray-900">¿Butcher paper o papel aluminio?</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">¿Cuánto tiempo tarda?</h2>
        <p className="text-sm leading-relaxed">
        ...
        <div className="bg-white border border-gray-100 rounded-xl p-4">
          <p className="text-sm font-semibold text-gray-900 mb-1">Consejo práctico</p>
      ...
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">Errores más comunes</h2>
      ...
      <div className="bg-gray-50 border border-gray-100 rounded-xl p-5 space-y-3">
        <p className="text-sm font-semibold text-gray-900">Resumen en 9 pasos</p>
      ...
      <div className="bg-gray-50 border border-gray-100 rounded-xl p-5 text-center space-y-3">
        <p className="text-sm font-semibold text-gray-900">¿Ya tienes el brisket? Planea el resto de la carne asada.</p>
        <p className="text-xs text-gray-500">La calculadora te dice exactamente cuánta carne, tortillas y más necesitas para tu grupo.</p>
        <Link
          href="/"
