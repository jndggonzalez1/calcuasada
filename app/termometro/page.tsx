  ...
  return (
    <article className="space-y-6 text-gray-700">
      ...
      <div className="text-center space-y-2">
        <p className="text-xs font-medium text-gray-400 uppercase tracking-widest">Referencia rápida</p>
      ...
      <section className="space-y-3">
        <h2 className="text-sm font-semibold text-gray-900">Las 3 temperaturas que debes recordar</h2>
        <div className="grid gap-3">
          <div className="bg-white border-l-4 border-brasa rounded-xl p-4 flex items-center gap-4">
            <div className="text-center min-w-[70px]">
              <p className="text-xl font-bold text-brasa">145°F</p>
          ...
          <div className="bg-white border-l-4 border-orange-400 rounded-xl p-4 flex items-center gap-4">
            <div className="text-center min-w-[70px]">
              <p className="text-xl font-bold text-orange-500">160°F</p>
          ...
          <div className="bg-white border-l-4 border-yellow-400 rounded-xl p-4 flex items-center gap-4">
            <div className="text-center min-w-[70px]">
              <p className="text-xl font-bold text-yellow-600">165°F</p>
      ...
      <section id="temperaturas" className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">🥩 Res — términos de cocción</h2>
        ...
        <div className="space-y-2">
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-3.5 flex items-center gap-3">
            ...
            <div className="text-right flex-shrink-0">
              <p className="text-sm font-semibold text-gray-800">110°F</p>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-3.5 flex items-center gap-3">
            ...
            <div className="text-right flex-shrink-0">
              <p className="text-sm font-semibold text-gray-800">120–130°F</p>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-3.5 flex items-center gap-3">
            ...
            <div className="text-right flex-shrink-0">
              <p className="text-sm font-semibold text-gray-800">130–135°F</p>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-3.5 flex items-center gap-3">
            ...
            <div className="text-right flex-shrink-0">
              <p className="text-sm font-semibold text-gray-800">135–145°F</p>
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-xl p-3.5 flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-1.5 flex-wrap">
                <p className="text-sm font-semibold text-gray-900">Al punto</p>
            ...
            <div className="text-right flex-shrink-0">
              <p className="text-sm font-semibold text-brasa">145–150°F</p>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-3.5 flex items-center gap-3">
            ...
            <div className="text-right flex-shrink-0">
              <p className="text-sm font-semibold text-gray-800">150–155°F</p>
          ...
          <div className="bg-white border border-gray-100 rounded-xl p-3.5 flex items-center gap-3">
            ...
            <div className="text-right flex-shrink-0">
              <p className="text-sm font-semibold text-gray-800">155°F+</p>
      ...
      {/* ── POLLO ── */}
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">🍗 Pollo y aves</h2>
        <p className="text-xs text-gray-500 leading-relaxed">
            ...
            <tbody className="divide-y divide-gray-100">
              {[
                ...
                <tr key={corte} className="hover:bg-gray-50">
                  ...
                  <td className="py-2.5 px-3 text-right font-semibold text-yellow-600">{temp}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      {/* ── CERDO ── */}
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">🐷 Cerdo</h2>
            ...
            <tbody className="divide-y divide-gray-100">
              {[
                ...
                <tr key={prod} className="hover:bg-gray-50">
                  ...
                  <td className="py-2.5 px-3 text-right font-semibold text-orange-500">{temp}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      {/* ── CORDERO ── */}
      <section className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">🐑 Cordero</h2>
        ...
        <div className="space-y-2">
          {[
            ...
            <div key={term} className="bg-white border border-gray-100 rounded-xl p-3.5 flex items-center gap-3">
              ...
              <div className="text-right flex-shrink-0">
                <p className="text-sm font-semibold text-gray-800">{temp}</p>
      ...
      <section id="tecnica-mano" className="space-y-3">
        <h2 className="text-base font-semibold text-gray-900">✋ Técnica de la mano (finger test)</h2>
        ...
        <div className="space-y-2">
          {[
            ...
            <div key={gesto} className="bg-white border border-gray-100 rounded-xl p-3.5 flex items-center gap-3">
              <div className={`w-3 h-3 rounded-full ${color} flex-shrink-0`} />
              <div className="flex-1 min-w-0">
      ...
      <div className="bg-gray-900 text-white rounded-xl p-5 space-y-2">
        <p className="font-semibold text-sm">🌡️ Nota de seguridad</p>
