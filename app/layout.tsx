      ...
      <body className="min-h-screen">
        ...
        <div className="sticky top-0 z-30 print:hidden">
          <header style={{ background: '#FAF7F2', borderBottom: '1px solid #E8E2D9' }}>
            <div className="max-w-lg mx-auto px-4 h-[80px] flex items-center justify-between gap-3">
              <Link href="/" className="flex items-center gap-3">
                ...
                <span className="font-bold tracking-tight" style={{ color: '#1A1A1A', fontSize: '1.9rem' }}>
                  Calcuasada
                </span>
              </Link>
              <TranslateButton />
